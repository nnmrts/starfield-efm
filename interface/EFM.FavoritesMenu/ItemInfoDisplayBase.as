package
{
	...
	public class ItemInfoDisplayBase extends MovieClip
	{
		...
		public function ItemInfoDisplayBase()
		{
			...
			{
				trace("ItemInfoDisplayBase.constructor TRACE ---------");
		...
		protected function PopulateDamageType(param1:Array):void
		{
			try
			{
				...
				{
					_loc4_ = this.DamageTypeHolder_mc.getChildAt(_loc3_) as DamageType;
					_loc4_.Icon_mc.gotoAndStop(InventoryItemUtils.GetElementalLabel(param1[_loc3_].iElementalType));
